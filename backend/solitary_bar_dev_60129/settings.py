"""
Django settings for solitary_bar_dev_60129 project.
...
ROOT_URLCONF = 'solitary_bar_dev_60129.urls'
...
WSGI_APPLICATION = 'solitary_bar_dev_60129.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_bar_dev_60129 API",
    "DESCRIPTION": "API documentation for solitary_bar_dev_60129 App",
    "VERSION": "v1",
}
